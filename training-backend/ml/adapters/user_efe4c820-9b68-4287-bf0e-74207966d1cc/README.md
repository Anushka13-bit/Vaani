# torgo_cluster_english_v1 — Static Seed Adapter
...
# → { "adapter_id": "torgo_cluster_english_v1", "version": 1, "download_url": "..." }

curl http://localhost:8000/v1/adapters/torgo_cluster_english_v1
...
| Field | Value |
|---|---|
| `adapter_id` | `torgo_cluster_english_v1` |
| `type` | `CLUSTER` |
| `language_code` | `en` |
